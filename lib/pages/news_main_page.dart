...
class NewsMainPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
        // AppBar は main_screenにて対応済みの場合には出さない
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Row(
                    ...
                    children: [
                      ...
                      bookmarkMap.containsKey(informationList[index].link!)
                          // BookmarkManager()
                          //         .getBookmarkState(informationList[index].link!)
                          ? Icon(Icons.bookmark,
                  ...
                  onTap: () {
                    launchUrlByRss(
                        context,
                        informationList[index].copyWith(
                            link: _customUrl(informationList[index].link!)));
                  },
